        ...
        <Box p={2}>
            ...
            <Box bgColor="white"  textColor="black" >
                ...
                <Box display='flex' flexDirection={{ base: "column", md: "row" }} gap="20px">
                    ...
                    <Box>
                    <Text fontSize={{ base: "15px", md: "25px" }} fontFamily="Arial" fontWeight="700">Vision: </Text>
                ...
                <Box display='flex' mt="50px" flexDirection={{ base: "column-reverse", md: "row" }} gap="20px">
                    ...
                    <Text fontSize={{ base: "15px", md: "25px" }} fontFamily="Arial" fontWeight="700">Mission: </Text>
                        <Text fontSize={{ base: "15px", md: "20px" }} mb={4} fontFamily="Arial" textAlign="justify">Our mission is to provide world-class PLM training and education that equips individuals and organizations with the knowledge, tools, and techniques to optimize the entire product lifecycle, from ideation to disposal.</Text>
